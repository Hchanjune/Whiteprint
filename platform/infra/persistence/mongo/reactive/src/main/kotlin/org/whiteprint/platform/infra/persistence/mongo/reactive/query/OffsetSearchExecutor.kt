...
/**
 * 오프셋 검색 실행기 — 파이프라인 조립/정렬/skip/limit/totalCount 병렬 count를 전부 처리한다.
 ...
 * mapper에 넘긴다.
 */
suspend fun <D : Any, T> ReactiveMongoOperations.offsetSearch(
    params: OffsetQueryParams,
    entityClass: Class<D>,
    filter: Criteria? = null,
    preSortStages: List<AggregationOperation> = emptyList(),
