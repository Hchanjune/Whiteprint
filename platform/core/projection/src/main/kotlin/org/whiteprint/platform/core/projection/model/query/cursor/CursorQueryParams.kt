...
import org.whiteprint.platform.core.projection.model.paging.cursor.CursorPageMeta
...
/**
 * 커서 페이지네이션 필드 계약. QueryParams(웹 바인딩)와 Query(port.in)가 **각각** 구현한다.
 ...
 * 정렬은 단일 필드 + `_id` tie-breaker만 지원한다.
 */
