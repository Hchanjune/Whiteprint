...
import com.hc.infra.cache.redis.model.LuaScript
...
class RedisAtomicOperations(
    ...
    companion object {
        ...
        private val incrementAndExpireScript = _root_ide_package_.com.hc.infra.cache.redis.model.LuaScript(
            script = INCREMENT_AND_EXPIRE_SCRIPT,
            resultType = Long::class.java
        )

        private val decrementAndExpireScript = _root_ide_package_.com.hc.infra.cache.redis.model.LuaScript(
            script = DECREMENT_AND_EXPIRE_SCRIPT,
            resultType = Long::class.java
        )

        private val incrementWithLimitScript = _root_ide_package_.com.hc.infra.cache.redis.model.LuaScript(
            script = INCREMENT_WITH_LIMIT_SCRIPT,
            resultType = List::class.java
        )
        private val incrementWithLimitAndExpireScript = _root_ide_package_.com.hc.infra.cache.redis.model.LuaScript(
            script = INCREMENT_WITH_LIMIT_AND_EXPIRE_SCRIPT,
            resultType = List::class.java
        )

        private val decrementWithLimitScript = _root_ide_package_.com.hc.infra.cache.redis.model.LuaScript(
            script = DECREMENT_WITH_LIMIT_SCRIPT,
            resultType = List::class.java
        )
        private val decrementWithLimitAndExpireScript = _root_ide_package_.com.hc.infra.cache.redis.model.LuaScript(
