...
import com.hc.infra.jpa.core.entity.contract.PersistableEntity
...
@MappedSuperclass
abstract class BaseEntity<ID: Serializable>: com.hc.infra.jpa.core.entity.contract.PersistableEntity<ID> {
